...
public enum ErrorCode {
    ...
    // 관리자 mp4 업로드 → 기준 좌표 추출. 확장자·파일 머리(ftyp) 검사에 걸린 것 — C001 로 뭉개면
    // 관리자가 «뭐가 틀렸는지» 를 못 본다.
    INVALID_REFERENCE_VIDEO(400, "W016", "mp4 영상 파일만 등록할 수 있습니다."),
    // AI 서킷브레이커가 OPEN 이면 파일도 DB 도 건드리기 **전에** 거부한다 (2026-09-17 confirm ㄴ). 저장은

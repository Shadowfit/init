...
상태: **설계 · 미결정 ① 결정됨 (2026-08-22)** — **붙일 자리는 «주간» 으로 확정**(사용자 결정, §12).
      나머지 실행·채택은 여전히 사용자 confirm 후 박제 ([[feedback_user_decides_not_claude]]) — **§12 미결정 5건.** → **2026-09-14 착수 결정 — §14 분기 A·B·C 결정됨(A-a·B-a+a-1·C-a), 구현 진행 중.**

...
작성일: 2026-09-08
최종 갱신: 2026-09-10 (§9 착수 현황 + §9.4 통주행 + §10 1차 실측 + **§11 세 라운드 정리**)
상태: **세 라운드 완료(EC2) · 채택 미결정** — 현재 상태 한 장은 [§11 정리](#11-정리--세-라운드가-답한-것과-남은-것-2026-09-10). (결정 ✅ 는 사용자 confirm 후)
...
- **아직 안 정한 것**: 어느 프로토콜을 쓸지(§11-4 의 ㄱ/ㄴ/ㄷ). 결정하면 **반대편 구현을

...
- [grpc-webclient-empirical-comparison.md](./grpc-webclient-empirical-comparison.md) — gRPC vs WebClient 실측 비교 (**1차 EC2 라운드 완료** §10 — nginx 홉 0.1~0.8ms 확정, 큰 페이로드는 판정 불가. **채택 미결정**)

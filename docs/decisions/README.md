...
- [grpc-webclient-empirical-comparison.md](./grpc-webclient-empirical-comparison.md) — gRPC vs WebClient 실측 비교 (③ 좁은 실측 **코드 착수됨**, `explore/grpc-webclient-ab` — 다만 **측정 0건·채택 미결정**, §9)

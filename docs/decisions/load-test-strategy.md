...
| SLO 수치 | 🟡 ② 실측 + batch 개선 완료 (§7.5·7.6·7.7) — **JdbcTemplate batch 로 throughput +99%·p50 −64%·p99 −37%**(공정측정). 에러 100건 = 측정 종료 아티팩트로 규명(§7.7, 서버 결함 아님). SLO "콜백 p99<20ms" 작업량 정의 불일치로 **재정의 필요**. 천장 특정·R 실측 미완 | 합격 기준 |

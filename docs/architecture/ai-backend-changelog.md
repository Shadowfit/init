...
> ⚠️ **이 4커밋은 대체가 아니라 «A/B 준비» 다.** RPC 표면·인증 경계·실패 처리 세 곳을 동시에 건드리므로(README 갱신 트리거 1·3·4 전부 해당) 여기 적지만, 기본 경로는 여전히 gRPC 이고 REST 미러는 `ai.client-type=webclient` 일 때만 쓰인다.
